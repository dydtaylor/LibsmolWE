...
* `corralsParams.txt`: Experimental code in development to simulate membrane corrals. This code does NOT currently work, and is not used in the paper. <!--Corrals are currently in an alpha version and as such that functionality is not currently used to produce data in any publications. Results from this functionality have NOT been confirmed through any brute force analysis / analytic analysis / other methods.-->
